  ...
  return (
    <LazyMotion features={domAnimation}>
      <div className="relative w-full min-h-screen bg-background text-foreground transition-colors duration-300 selection:bg-yellow-500/30">
        ...
        <m.div style={{ opacity: heroOpacity, pointerEvents: pointerEventsHero as any }} className="block md:hidden">
          <VerticalEmail />
        </m.div>
        ...
        <div className="fixed top-0 left-0 w-[40%] h-screen z-30 hidden md:flex flex-col pl-32 pt-[25vh] pointer-events-none">
          <m.div style={{ opacity: sidebarOpacity, y: sidebarY, pointerEvents: 'auto' }} className="flex flex-col gap-10 items-start mt-4">
        ...
        <m.div style={{ opacity: heroOpacity }} className="fixed bottom-16 right-16 z-20 hidden md:flex flex-col items-center gap-2 text-center">
        ...
        {/* --- Main Content Area --- */}
        <m.div style={{ y: isMobile ? contentY : 0 }} className="relative w-full z-20">
